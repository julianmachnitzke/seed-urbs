...
def read_input(input_files, year):
    ...
    directory = os.path.join(scripts_dir, 'Input', 'json')
    # directory = r'C:\Users\julia\Desktop\01_Environemental_Engineering\06_Project_Lab_RES\05_full_website_test\urbs-master\Input\json'
